# hypeblitz organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`hypeblitz`](https://github.com/hypeblitz).

## Canonical organization links

- GitHub organization: https://github.com/hypeblitz
- Public organization defaults: https://github.com/hypeblitz/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomhypeblitz-0290c506bc1d
...
`hypeblitz` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
